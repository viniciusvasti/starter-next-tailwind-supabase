...
>(({ className, ...props }, ref) => {
  const nonShadcnStyles =
    "text-dark100_light900 background-light900_dark300 rounded border dark:border-dark-400";
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-dark100_light900 text-lg font-semibold", className)}
    {...props}
  />
));
